...
```shell
wget https://github.com/reneManqueros/moxxiproxy/releases/download/v1.4.5/moxxiproxy_1.4.5_Linux_x86_64.tar.gz && tar xf moxxiproxy_1.4.5_Linux_x86_64.tar.gz 
```
